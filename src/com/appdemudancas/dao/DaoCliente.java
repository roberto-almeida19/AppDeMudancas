...
public class DaoCliente implements IDaoCliente {
	...
	public void criarCliente(Cliente cliente) throws SQLException {
		...
		String query = "INSERT INTO cliente(" + "cpf,nome,telefone,data_nascimento,email," + "senha,data_cadastro,"
				+ "enderecoCodigo_endereco) " + "VALUES(?,?,?,?,?,?,?,?);";
	...
	private ResultSet gerarResultSet(Cliente cliente) throws SQLException {
		...
		String query = "SELECT * FROM cliente WHERE " + "cliente.cpf=? OR " + "cliente.nome=? OR "
				+ "cliente.telefone=? OR " + "cliente.data_nascimento=? OR " + "cliente.email=? OR "
				+ "cliente.data_cadastro=? OR " + "cliente.endereco_clienteCodigo_endereco=?;";
